                                ...
                                <table class="table no-wrap">
                                    ...
                                    <tbody>
                                        <tr class="advanced-table active">
                                            ...
                                            <td>
                                                <img src="{{asset('assets/images/users/1.jpg')}}" class="rounded-circle"
                                                    width="30">
                                            </td>
                                            <td>Andrew Simons</td>
                                            <td>Modulator</td>
                                        ...
                                        <tr class="advanced-table">
                                            ...
                                            <td>
                                                <img src="{{asset('assets/images/users/2.jpg')}}" class="rounded-circle"
                                                    width="30">
                                            </td>
                                            <td>Hanna Gover</td>
                                            <td>Admin </td>
                                        ...
                                        <tr class="advanced-table">
                                            ...
                                            <td>
                                                <img src="{{asset('assets/images/users/3.jpg')}}" class="rounded-circle"
                                                    width="30">
                                            </td>
                                            <td>Joshi Nirav</td>
                                            <td>Admin</td>
                                        ...
                                        <tr class="advanced-table">
                                            ...
                                            <td>
                                                <img src="{{asset('assets/images/users/4.jpg')}}" class="rounded-circle"
                                                    width="30">
                                            </td>
                                            <td>Joshi Sunil</td>
                                            <td>Admin</td>
        ...
        <div class="col-md-12 col-lg-4">
            <div class="card">
                <div class="d-flex align-items-center px-3 py-4 border-bottom">
                    ...
                    <div class="ml-auto">
                        <button class="btn btn-danger text-white btn-rounded" data-toggle="modal"
