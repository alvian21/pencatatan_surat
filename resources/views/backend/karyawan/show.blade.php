                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="nama" value="{{$karyawan->name_e}}"
                                        name="nama">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="alamat" value="{{$karyawan->address}}"
                                        name="alamat">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly required id="old_tipe" name="old_tipe[]" value="{{$item->type}}">
                                    </div>
                                </div>
