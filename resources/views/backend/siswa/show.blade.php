...
<div class="page-content container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Detail Ijazah Siswa</h4>
                    <form class="mt-4" method="post" action="{{route('siswa.update',[$siswa->id_sd])}}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" value="{{$siswa->name}}" id="nama"
                                        name="nama">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" readonly class="form-control" value="{{$siswa->birth_date_s}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" id="tempat_lahir"
                                        value="{{$siswa->birth_place_s}}" name="tempat_lahir">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_orangtua"
                                        value="{{$siswa->parents_name}}" readonly name="nama_orangtua">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="nisn" value="{{$siswa->nisn}}"
                                        name="nisn">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="nis" value="{{$siswa->nis}}" name="nis">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="npsn" value="{{$siswa->npsn}}"
                                        name="npsn">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <a href="{{asset('storage/certificate/'.$item->name)}}"
                                            target="blank">{{$item->name}}</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="old_tipe">Tipe</label>
                                        <input type="text" class="form-control" required id="old_tipe" readonly
                        ...
                        <div class="row  mt-2">
                            <div class="col-md-12 text-center">
                                <a href="{{route('siswa.index')}}" class="btn btn-secondary">Tutup</a>
