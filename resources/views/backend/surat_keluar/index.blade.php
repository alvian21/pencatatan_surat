                        ...
                        <table id="table-siswa" class="table table-striped border text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{date("j F Y", strtotime($item->letter_date_o))}}</td>
                                    <td>{{$item->to}}</td>
                                    <td>{{$item->description_letter_code}}</td>
                                    <td><a href="{{route('surat_keluar.download',[$item->id_outgoing])}}"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger hapus"
                                            data-id="{{$item->id_outgoing}}"> <i class="mdi mdi-delete"></i></button>
                                    </td>
                                </tr>
                                @empty
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" id="formSurat">
                                        ...
                                        <input type="hidden" name="id" name="id" class="id_outgoing">
